<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<!-- footer -->
			...
			<div class="container py-sm-3">
				<div class="row footer-grids">
					<div class="col-lg-3 col-sm-6 mb-lg-0 mb-sm-5 mb-4">
						<h2> <a class="navbar-brand mb-3" href="Home.jsp">Anxiety</a>
						</h2>
						<p class="mb-3">World largest online education. website portal,roaksh is begine here.</p>
						<h5>Trusted by <span>500+ People</span> </h5>
					</div>
					<div class="col-lg-3 col-sm-6 mb-md-0 mb-sm-5 mb-4">
						<h4 class="mb-4">Address Info</h4>
						<p><span class="fa mr-2 fa-map-marker"></span>across laxman swami temple  <span>Pandhurli,Maharastra, India.</span></p>
						<p class="phone py-2"><span class="fa mr-2 fa-phone"></span> +(91) 9975057282  </p>
						<p><span class="fa mr-2 fa-envelope"></span><a href="mailto:info@example.com">pawarrohan8086@gmail.com</a></p>
					</div>
					...
					<div class="col-lg-4 col-sm-6">
						...
						<div class="icon-social mt-4">
							...
							<a href="#" class="button-footr">
								<span class="fa mx-2 fa-github"></span>
							</a>
							<a href="#" class="button-footr">
		...
		<div class="copy_right p-3 d-flex justify-content-around">
			...
			<p>© 2020 Roaksh. All rights reserved | Design by
				<a href="Home.jsp">Roaksh pvt ltd.</a>
