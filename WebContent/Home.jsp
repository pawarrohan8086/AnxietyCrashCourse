					...
					<div class="col-lg-5 login p-md-5 p-4 mx-auto bg-white mw-100">
						...
						<div >
							<form action="StudentSignIn" class="needs-validation"  novalidate>
								...
								<div id="message">
									<h6 style="color: green">Password must contain the following:</h6><br>
									...
									<div class="form-group">
										...
										<input type="password" class="form-control" id="psw" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
										<div class="valid-feedback">Valid.</div>
										<div class="invalid-feedback">Please fill out this field.</div>
									</div>
									<div class="form-group">
										...
										<div class="form-group mb-4">
											<div class="form-check-inline">	
												<label class="form-check-label" for="radio1" style="color:#404747;">
													<input type="radio" class="form-check-input" id="radio1" name="user" value="student" checked>student
												</label>
											</div>
											<div class="form-check-inline">
												<label class="form-check-label" for="radio2" style="color:#404747;">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input type="radio" class="form-check-input" id="radio2" name="user" value="admin">admin
												</label>
											</div>
										</div>
								<div class="form-group">
...
<script src="http://localhost:8080/AnxietyCrashCourse/web/js/validation.js"></script>
