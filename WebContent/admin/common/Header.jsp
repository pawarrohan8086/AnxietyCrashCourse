			...
			<div class="nav_w3pvt text-center">
				...
				<nav class="lavi-wthree">
					<div id="logo">
						<h1>
							<a class="navbar-brand"
								href="common/Home.jsp">Anxiety</a>
						</h1>
					</div>
					...
					<ul class="menu mr-auto">
						<li><a
							href="common/Home.jsp">Home</a></li>
						<li><a
							href="common/about.jsp">About</a></li>
						<li>
							...
							<ul>
								<li><a
									href="common/Home.jsp#features">Features</a></li>
								<li><a
									href="common/Home.jsp#services">Services</a></li>
								<li><a
									href="common/Home.jsp#gallery">Gallery</a></li>
								<li><a
									href="common/Home.jsp#test">Testimonials</a></li>
								<li><a
									href="common/blog.jsp">Blogs</a></li>
							</ul>
						</li>
						<li><a
							href="common/contact.jsp">Contact</a></li>
