					...
					<div class="row">
						...
						<div class="col-sm-4 service-1-w3ls serve-gd2">
							<div class="serve-grid team-gd mt-4">
								<img src="/AnxietyCrashCourse/web/images/t1.jpg" alt="img"
									class="img-fluid image1">
								<p class="mt-3">Professor 1</p>
							</div>
							<div class="serve-grid team-gd mt-4">
								<img src="/AnxietyCrashCourse/web/images/t2.jpg" alt="img"
									class="img-fluid image1">
						...
						<div class="col-sm-4 service-1-w3ls serve-gd3">
							<div class="serve-grid team-gd mt-4">
								<img src="/AnxietyCrashCourse/web/images/t3.jpg" alt="img"
									class="img-fluid image1">
								<p class="mt-3">Professor 3</p>
							</div>
							<div class="serve-grid  team-gd mt-4">
								<img src="/AnxietyCrashCourse/web/images/t4.jpg" alt="img"
									class="img-fluid image1">
								<p class="text-li mt-2">Professor 4</p>
							</div>
							<div class="serve-grid team-gd mt-4">
								<img src="/AnxietyCrashCourse/web/images/t5.jpg" alt="img"
									class="img-fluid image1">
						...
						<div class="col-sm-4 service-1-w3ls serve-gd2">
							<div class="serve-grid team-gd mt-4">
								<img src="/AnxietyCrashCourse/web/images/t6.jpg" alt="img"
									class="img-fluid image1">
