                ...
                <nav class="lavi-wthree">
					...
					<ul class="menu mr-auto">
						...
						<li>
							...
							<ul>
								<li><a href="Home.jsp#features">Features</a>
								</li>
								<li><a href="Home.jsp#services">Services</a>
								</li>
								<li><a href="Home.jsp#gallery">Gallery</a>
								</li>
								<li><a href="Home.jsp#test">Testimonials</a>
								</li>
						...
						<li class="log-vj ml-lg-5">
							...
							<ul>
								<li><a href="Home.jsp#apply">login</a>
								</li>
								<li><a href="Home.jsp#apply">sign up</a>
								</li>
							</ul>
						</li>
						</ul>
                        ...
                        <li>
                            <div class="row mt-5">
                                ...
                                <div class="col-9">
                                    <h6>Address</h6>
                                    <p>Roaksh info tech.
                                        <br>city centre mall,indira gandi Park,
                                        <br>Nashik City. </p>
                                </div>
                            </div>
                        </li>
